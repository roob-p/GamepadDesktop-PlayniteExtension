...
This period also serves as an "emergency" fallback in case the OS steals focus (e.g., due to a software update). After that time, the script enters idle mode until `Playnite` is active again.  
